...
public class Server implements ActionListener {
    ...
    Server(){
     ...
     Image i2=i1.getImage().getScaledInstance(24, 25, Image.SCALE_DEFAULT);
     ...
     back.addMouseListener(new MouseAdapter(){
       ...
       ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/3670051.png"));
